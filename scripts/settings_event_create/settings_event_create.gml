...
for (var i = 0; i < array_length_1d(global.settings_labels); i++) {
    ...
    settings_setup_arrow(arrow_left, ARROW_TYPES.left, global.settings_labels[i], spr_arrow_left);
    settings_setup_arrow(arrow_right, ARROW_TYPES.right, global.settings_labels[i], spr_arrow_right);
}
