...
global.runling_prototypes[? RUNLING_TYPES.hydralisk] = create_runling_prototype(
    ...
    create_ability(ability_tunnel, ABILITY_TYPES.continuous, 20, 300),
    create_ability(ability_snap_freeze, ABILITY_TYPES.oneshot, 15, 0),
);
global.runling_prototypes[? RUNLING_TYPES.ultralisk] = create_runling_prototype(
    [spr_ultralisk_left, spr_ultralisk_right],
    create_ability(ability_time_lord, ABILITY_TYPES.toggleable, 5, 0),
    create_ability(ability_ultra_freeze, ABILITY_TYPES.oneshot, 15, 0),
);
global.runling_prototypes[? RUNLING_TYPES.roach] = create_runling_prototype(
    [spr_roach_left, spr_roach_right],
    create_ability(ability_swiftness, ABILITY_TYPES.oneshot, 10, 0),
